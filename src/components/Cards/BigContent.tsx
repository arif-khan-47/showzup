        ...
        <>
            <View style={{
                ...
                <View style={{ height: '100%', width: '100%', position: 'relative' }}>
                    ...
                    />
                    {/* <View style={{ position: 'absolute', height: '40%', width: '100%', bottom: 0,}}> */}
                    <LinearGradient colors={['rgba(255, 255, 255, 0.1)', 'rgba(255, 255, 255, 0.4)', 'rgba(0,0,0,1)']} style={{ position: 'absolute', height: '100%', width: '100%', bottom: 0}}>
                        ...
                        <View style={{ bottom: 0, left: 0, right: 0, top: '60%', position: 'absolute', paddingHorizontal: 10 }}>
                            ...
                            />
                            <Text style={{ fontWeight: '700', fontSize: 30, marginLeft: 5, color: 'white', paddingTop: 10 }}>{data.title}</Text>
                            <Text style={{ marginLeft: 5, color: 'white', fontSize: 15 }}>{data.catagory}.<Text style={{ color: '#FF6600' }}> {data.year}</Text>. {data.duration}</Text>
                            ...
                            <View style={{ position: 'absolute', bottom: '10%', width: '106%', height: '23%', flexDirection: 'row',justifyContent: 'space-between', paddingHorizontal: '2%'}}>
                                <TouchableOpacity 
                                onPress={() => navigation.navigate("SingleMovie",{name:data.title, poster:data.img, description:data.title, cast:data.cast})}
